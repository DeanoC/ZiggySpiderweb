...
const builtin_packages = [_]BuiltinPackageSpec{
    ...
    .{ .venom_id = "chat", .kind = "chat", .default_provider_scope = "session_dynamic", .default_target_path = "/nodes/local/venoms/chat", .categories_json = "[\"chat\",\"session\"]", .hosts_json = "[\"spiderweb\"]", .projection_modes_json = "[\"session_dynamic\",\"host_local\"]", .help_md = "Inbound and outbound chat surface for attached users and agents." },
    .{ .venom_id = "jobs", .kind = "jobs", .default_provider_scope = "session_dynamic", .default_target_path = "/nodes/local/venoms/jobs", .categories_json = "[\"jobs\",\"queue\"]", .hosts_json = "[\"spiderweb\"]", .projection_modes_json = "[\"session_dynamic\",\"host_local\"]", .help_md = "Durable job queue and result surface." },
    ...
    .{ .venom_id = "memory", .kind = "memory", .default_provider_scope = "worker_private", .categories_json = "[\"memory\",\"agent_private\"]", .hosts_json = "[\"worker\"]", .projection_modes_json = "[\"worker_private\"]", .help_md = "Worker-private memory service." },
    .{ .venom_id = "sub_brains", .kind = "sub_brains", .default_provider_scope = "worker_private", .categories_json = "[\"agent_private\",\"sub_brains\"]", .hosts_json = "[\"worker\"]", .projection_modes_json = "[\"worker_private\"]", .help_md = "Worker-private sub-brain service." },
};
