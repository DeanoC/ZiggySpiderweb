...
9. Use `/services/pr_review/control/run_validation.json` to execute the configured review commands through `/global/terminal`, persist per-command service captures, and refresh the latest validation summary in state.
