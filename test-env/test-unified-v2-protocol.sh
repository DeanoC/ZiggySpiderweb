...
def run_source_guard(root_dir: str) -> None:
    checks = [
        ...
        ("src/acheron/mount_main.zig", '\\"channel\\":\\"control\\",\\"type\\":\\"control.version\\"'),
        ("src/acheron/mount_main.zig", '\\"channel\\":\\"control\\",\\"type\\":\\"control.connect\\"'),
        ("src/acheron/mount_main.zig", '\\"channel\\":\\"control\\",\\"type\\":\\"control.workspace_status\\"'),
