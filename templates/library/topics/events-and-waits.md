...
1. Write wait selector payload to `/global/events/control/wait.json`.
2. Read `/global/events/next.json` to block for the first matching event.
...
Synthetic signals can be emitted through `/global/events/control/signal.json` for
