...
pub const Session = struct {
    ...
    fn sessionJsonObjectOptionalString(self: *Session, obj: std.json.ObjectMap, key: []const u8) !?[]const u8 {
        _ = self;
        return jsonObjectOptionalString(obj, key);
    }

    fn sessionJsonObjectOptionalBool(self: *Session, obj: std.json.ObjectMap, key: []const u8) !?bool {
        _ = self;
        return jsonObjectOptionalBool(obj, key);
    }

    fn sessionJsonObjectOptionalU64(self: *Session, obj: std.json.ObjectMap, key: []const u8) !?u64 {
        _ = self;
    ...
    fn parseShellExecPayload(self: *Session, payload_json: []const u8) !ParsedShellExecResult {
